		...
		<article class="ms-lg-4 mt-4 mt-lg-0" style="max-width: 320px">
				...
				<figure class="itemside align-items-center mb-4">
					<div class="aside">
						...
						<img src="~/static/images/items/7.jpg" class="img-sm rounded border">
					</div>
				...
				<figure class="itemside align-items-center mb-4">
					<div class="aside">
						<b class="badge bg-secondary rounded-pill">1</b>
						<img src="~/static/images/items/5.jpg" class="img-sm rounded border">
					</div>
					<figcaption class="info">
				...
				<figure class="itemside align-items-center mb-4">
					<div class="aside">
						...
						<img src="~/static/images/items/1.jpg" class="img-sm rounded border">
					</div>
					<figcaption class="info">
